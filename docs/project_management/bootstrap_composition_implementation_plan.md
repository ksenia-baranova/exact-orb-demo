...
**Статус:** промты 1–2 выполнены; промт 3 не начат.
...
изменения и проверки промтов 1–2 записаны выше; команды промта 3 ещё не
запускались. Унаследованный тест промта 2 воспроизвёл loop warning при отмене
...
component-тестом. Сквозные AC-2 и AC-9 остаются промту 3.
