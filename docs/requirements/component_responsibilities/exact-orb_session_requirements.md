...
Ревизия 2026-09-12: добавлено принятое, но не реализованное следствие
ADR-0032 для state payload.
...
ADR-0032 заранее фиксирует такое несовместимое изменение для следующего
этапа: state payload становится v2, dialog payload остаётся v1. Decoder v2
обязан читать обе state-версии. При чтении state v1 известное время получает
...
До implementation-этапа `_STATE_PAYLOAD_VERSION == 1`, frozen fixture v1 и
действующий encode/decode не меняются.
